...
def run_linear(
    ...
    """
    linear = MyLinear(d_in, d_out, device=in_features.device, dtype=in_features.dtype)
...
def run_embedding(
    ...
    embedding = MyEmbedding(vocab_size, d_model, device=token_ids.device)
...
def run_transformer_block(
    ...
    """
    return TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta, weights)(in_features)
...
def run_transformer_lm(
    ...
    """
    return TransformerLM(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta, weights)(in_indices)
